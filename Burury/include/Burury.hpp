#ifndef QT_SSL_EXAMPLE_CLIENT_Burury_H__
#define QT_SSL_EXAMPLE_CLIENT_Burury_H__
...
class Burury : public QMainWindow {
        Q_OBJECT

        public:
                Burury(const Settings&, QWidget *parent = NULL);
...
#endif // QT_SSL_EXAMPLE_CLIENT_Burury_H__
