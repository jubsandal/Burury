...
ResponseWaiter::ResponseWaiter(QObject * p) : QObject(p)
{ }
...
void
Service::sendCommand(int handler_id, QJsonObject payload, ResponseWaiter * waiter, iiNPack::PacketType pack_type)
{
        ...
        // TODO add check
        QJsonDocument d;
        d.setObject(API::Handler::createCall(handler_id, payload));
